...
export const ExperienceCard = ({ exp, index, onClick }) => {
  return (
    <motion.div
      ...
      className="glass p-8 rounded-3xl border border-white/5 hover:border-[var(--color-neon-blue)]/30 transition-colors relative overflow-hidden group h-full flex flex-col"
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        <div className="flex flex-col gap-2 mb-4">
          ...
          <p className="text-[var(--color-neon-blue)] font-mono text-sm">{exp.company}</p>
        ...
        <div className="mt-auto">
          <Button variant="ghost" className="px-0 hover:text-[var(--color-neon-blue)]" onClick={() => onClick(exp)}>
