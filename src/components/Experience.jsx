      ...
      <div className="container mx-auto px-6">
        <div className="mb-16 flex flex-col items-center text-center">
          <h2 className="text-4xl md:text-5xl font-bold font-roboto mb-4">
            <span className="text-[var(--color-neon-pink)] text-glow mr-4">Professional</span> Experience
          </h2>
        ...
        {selectedExp && (
          <div className="text-gray-300">
            <div className="mb-6 flex items-center gap-4 flex-wrap">
              <span className="px-3 py-1 bg-[var(--color-neon-pink)]/20 text-[var(--color-neon-pink)] border border-[var(--color-neon-pink)]/50 rounded-full text-sm font-mono">
                {selectedExp.duration}
              </span>
              {selectedExp.certificateLink && (
                <a href={selectedExp.certificateLink} target="_blank" rel="noopener noreferrer">
                  <Button variant="ghost" className="px-3 py-1.5 text-sm border border-[var(--color-neon-green)]/50 text-[var(--color-neon-green)] hover:bg-[var(--color-neon-green)]/10 h-auto">
